...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'basic/vendor_input/:cuCode',
        name: 'baseVendorEidt',
        component: () => import('@/views/base/BaseVendorInput'),
        meta: {
          title: '거래처수정'
      ...
      // },
      {
        path: 'basic/item_group_list',
        name: 'baseItemsGroup',
        component: () => import('@/views/base/BaseItemsGroup'),
        meta: {
          title: '품목분류관리'
        }
      },
      ...
      {
        path: 'basic/items_input/:itemId',
        name: 'baseItemsDetail',
        component: () => import('@/views/base/BaseItemsInput'),
        meta: {
          title: '품목상세'
        }
      ...
      // ********************************************************
      // #region 상품관리(상품분류관리/상품관리/상품정보일괄변경)
      // ********************************************************
      {
        path: 'goods/group_list',
        name: 'productGroup',
        component: () => import('@/views/product/ProductGroup'),
        meta: {
          title: '상품분류관리'
        }
      },
      {
        path: 'goods/group_manage',
        name: 'productGroupManage',
        component: () => import('@/views/product/ProductGroupManage'),
        props: true,
        meta: {
          title: '상품분류 등록/수정'
        }
