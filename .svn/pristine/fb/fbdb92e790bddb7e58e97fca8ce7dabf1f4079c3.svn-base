<template>
  <div id="stockReturnPrintModal" class="modal-mask">
    <div class="modal-dialog modal-item">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">반품관리 현황</h4>
                    ...
                    <div class="col-sm-12">
                        <div class="widget no-margin" id="print">
                            <div class="widget-header">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 d-flex justify-content-center buy_title">반품관리 현황</div>
                            ...
                            <div class="widget">
                                <div class="widget-body">
                                    <table class="table table-bordered mb-0" summary="반품관리 리스트">
                                        <colgroup>
                                            <col width="10%">
                                            <col width="7%">
                                            <col width="10%">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="text-center">2020-09-15</td>
                                                <td class="text-center">홍길동</td>
                                                <td class="text-center">123456789</td>
                                                <td class="text-center">123456789</td>
                                                <td class="text-center">홍길동</td>
                                                <td class="text-center">010-2234-1235</td>
                                                <td class="text-center">14770</td>
                                                <td>서울시 강남구 대치동</td>
                                            </tr>
                                            <tr>
                                                <td class="text-center">2020-09-15</td>
