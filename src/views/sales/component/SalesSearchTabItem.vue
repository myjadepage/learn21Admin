  ...
  <div class="tab-pane show active">
                    <div class="widget has-shadow">
                        <div class="widget-body">
                            <table class="table table-bordered" summary="품목별 매출 검색하기">
                                <colgroup>
                                    <col width="10%">
                                    <col width="40%">
                                    <col width="10%">
                        ...
                        <div class="widget-header bordered">
                            <div class="row">
                                ...
                                <div
                                    ...
                                    <button class="btn btn-outline-secondary" @click="openModalPopup('salesSearhItemPrint')">인쇄</button>
                                </div>
                                <sales-search-item-print-popup v-if="modalOpenFlag && modalPopupId === 'salesSearhItemPrint'" @close="closeModalPopup"></sales-search-item-print-popup>
                            </div>
                        </div>
                        <div class="widget-body">
                            <table id="stock-list-table" class="table table-bordered mb-0" summary="품목별 매출조회 리스트">
                                <colgroup>
                                    <col width="20%">
                                    <col width="10%">
                                    <col width="15%">
...
import SalesSearchItemPrintPopup from '@/components/popup/print/SalesSearchItemPrintPopup.vue'
    ...
    openModalPopup (id) {
      switch (id) {
        ...
        case 'itemSelectSingle': // 품목단일 선택
          ...
          break
        case 'salesSearhItemPrint': // 품목프린트
          this.modalPopupId = 'salesSearhItemPrint'
          break
      }
