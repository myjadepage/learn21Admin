    ...
    <div class="row">
      <PageHeader :pageCurrentInfo="pageCurrentInfo" />
       ...
       <div class="col-sm-12">
        ...
        <div class="widget has-shadow">
            <div class="widget-header bordered">
                <div class="row">
                    ...
                    <div class="col-sm-6 d-flex align-items-center justify-content-md-end justify-content-center">
                        <button class="btn btn-outline-dark btn-excel" @click="excelDownFunc">엑셀다운로드</button>
            ...
            <div class="widget-body">
               <v-table :rows="rows" :columns="columns" :config="config" :classes="classes" :show-loader="showLoader">
                 ...
                 <template slot="cuName" slot-scope="props">
                   <a href="#" @click="openModalPopup(props.row, 'buyInvoice')">{{ props.cell_value }}</a>
                 </template>
                 ...
                 <template slot="button" slot-scope="">
                      ...
                      <button class="btn btn-sm btn-outline-danger" @click="delRow(props.row.index)"> 삭제 </button>
                 </template>
               </v-table>
            </div>
            <!-- 리스트영역 끝 -->
        ...
        <buy-invoice-popup title="구매발주서 등록" v-if="modalOpenFlag && modalPopupId === 'buyInvoice'" @close="closeModalPopup" :modalParamObj="modalParamObj"></buy-invoice-popup>
...
export default {
  ...
  data () {
    return {
      ...
      columns: [
        ...
        {label: '관리', name: 'button', sort: false, row_classes: 'w80'}],
      config: {
        pagination: true,
  ...
  methods: {
    ...
    excelDownFunc () {
      ...
      let dataWS = XLSX.utils.json_to_sheet(this.rows)
