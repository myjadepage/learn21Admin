    ...
    <div class="modal-dialog modal-item">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">품목별 매출현황</h4>
                    ...
                    <div class="col-sm-12">
                        <div class="widget no-margin" id="print">
                            <div class="widget-header">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 d-flex justify-content-center buy_title">품목별 매출현황</div>
                            ...
                            <div class="widget-body">
                                <table id="stock-list-table" class="table table-bordered mb-0" summary="거래처별 매출조회 리스트">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th rowspan="6">PB TOEFL JUNIOR SET (A)</th>
                                            <th class="text-left">[소계]</th>
                                            <td></td>
                                            <td>80</td>
                                            <td></td>
                                            <td>100,000</td>
